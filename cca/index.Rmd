...
plot_pca_vec <- function(pc_vec, x=1, y=2) {
  ...
  t$color <- samples_colors(as.vector(t$sample))
  p <- ggplot(t, aes(x=pcx, y=pcy)) + geom_point(aes(color=color)) +
...
print(plot_pca_vec(pe$vec))
```

```{r fig.width=6, fig.height=4}
print(plot_pca_val(pe$val))
```
...
```{r fig.width=6, fig.height=6}
print(plot_pca_vec(pm$vec))
```

```{r fig.width=6, fig.height=4}
print(plot_pca_val(pm$val))
```
...
d$color <- samples_colors(as.vector(d$sample))
